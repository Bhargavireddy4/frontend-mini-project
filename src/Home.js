  ...
  return (
    ...
    <div className="search-bar">
      ...
      <input
        ...
        className="search-input title-font paragraph-font text-color "
        value={searchTerm}
...
function ProductCard({ product }) {
  ...
  return (
    <div
      className={`product-card-container  rounded-md shadow-md overflow-hidden `}
    ...
    >
      <img
        src={product.image}
        alt={product.title}
        className="product-card-image rounded-t-md "
        style={{objectPosition: 'center', height: '250px' }}
      />
...
function HomePage() {
  ...
  return (
    ...
    <div class="head"><p>ShopMore</p> <Search searchTerm={searchTerm} onSearchChange={handleSearchChange} onSearchSubmit={handleSearchSubmit} /></div>
